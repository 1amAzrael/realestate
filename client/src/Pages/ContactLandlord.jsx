  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-white text-xl font-medium">Loading landlord information...</div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-900 text-white p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center mb-8">
          <button 
            onClick={handleGoBack} 
            className="mr-4 bg-gray-700 hover:bg-gray-600 text-white p-2 rounded-full transition-colors"
          >
            <FaArrowLeft />
          </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-1 bg-gray-800 rounded-lg p-6 shadow-lg">
              <h2 className="text-xl font-bold mb-4 flex items-center">
                <FaHome className="mr-2 text-blue-400" /> Property Details
              </h2>
              ...
              <h3 className="text-lg font-semibold text-blue-300">{listing.name}</h3>
              <p className="text-gray-400 mb-2">{listing.address}</p>
                  ...
                  {listing.offer && listing.discountPrice !== undefined ? (
                    <>
                      <div className="flex flex-col space-y-1">
                        ...
                        <div className="flex items-center">
                          <span className="text-yellow-400 font-bold">Final Price: </span>
            ...
            <div className="md:col-span-2 bg-gray-800 rounded-lg p-6 shadow-lg">
              <div className="border-b border-gray-700 pb-4 mb-6">
                <h2 className="text-xl font-bold mb-4 flex items-center">
                  <FaUser className="mr-2 text-purple-400" /> Landlord Information
                </h2>
                <div className="flex flex-col space-y-3">
                  <div className="flex items-center">
                    <span className="bg-purple-800 p-2 rounded-full mr-3">
                  ...
                  {landlord.phone && (
                    <div className="flex items-center">
                      <span className="bg-blue-800 p-2 rounded-full mr-3">
                  ...
                  <div className="flex items-center">
                    <span className="bg-green-800 p-2 rounded-full mr-3">
              ...
              <h2 className="text-xl font-bold mb-4 flex items-center">
                <FaPaperPlane className="mr-2 text-green-400" /> Send a Message
              </h2>
              ...
              <div className="space-y-4">
                <textarea
                  ...
                  className="w-full p-4 border bg-gray-700 border-gray-600 rounded text-white focus:outline-none focus:ring-2 focus:ring-purple-500 resize-none"
                  rows="5"
                ></textarea>
                ...
                <div className="flex flex-col space-y-3 sm:flex-row sm:space-y-0 sm:space-x-3">
                  ...
                  {landlord.phone && (
                    <a
                      ...
                      className="flex-1 flex items-center justify-center space-x-2 bg-gradient-to-r from-blue-600 to-green-600 text-white px-6 py-3 rounded-lg hover:from-blue-700 hover:to-green-700 transition-colors"
                    >
                      <FaPhone />
                      <span>Call Now</span>
                    </a>
